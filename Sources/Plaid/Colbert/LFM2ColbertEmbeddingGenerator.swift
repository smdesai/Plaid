...
public final class LFM2ColbertEmbeddingGenerator: ColbertEmbeddingGenerator {
    ...
    private let tokenizer: PreTrainedColbertTokenizer
    ...
    public init(
        tokenizer: PreTrainedColbertTokenizer,
    ...
    private static func buildSkiplist(tokenizer: PreTrainedColbertTokenizer, words: [String])
        -> Set<Int>
    {
        var set = Set<Int>()
        for word in words {
